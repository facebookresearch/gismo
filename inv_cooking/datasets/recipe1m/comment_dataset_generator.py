...
def create_substituions_datasets(
    ...
    create_substituions(train_dataset, train_id2ing, vocab_ings, train_dataset_path)
    create_substituions(val_dataset, val_id2ing, vocab_ings, val_dataset_path)
    create_substituions(test_dataset, test_id2ing, vocab_ings, test_dataset_path)
